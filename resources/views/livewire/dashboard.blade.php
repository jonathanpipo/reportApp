<div class="bg-white flex flex-col gap-6">
    <div class="bg-gradient-to-b from-gray-100 to-gray-200 text-white shadow-inner">
        <div class="container mx-auto flex items-center justify-between py-4 px-4">
            <h1 class="text-2xl font-semibold text-gray-800">Indicadores</h1>
            <button 
                @click="open = true" 
...
<div class="container mx-auto flex flex-col gap-6 p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center gap-4">
            <div class="flex flex-col items-center">
                <h2 class="text-xl font-semibold text-gray-700 mb-1">Total de Denúncias: {{ collect($dataCategoria)->sum() }}</h2>
            </div>
            ...
            <div class="grid grid-cols-1 gap-3 w-full max-w-md">
                ...
                <div class="bg-gray-100 rounded-lg px-4 py-2 flex items-center justify-between">
                    <span class="font-medium text-gray-700">Sinalização deficiente: {{ $totalSinalizaçãoDeficiente }}</span>
                </div>
                <div class="bg-gray-100 rounded-lg px-4 py-2 flex items-center justify-between">
                    <span class="font-medium text-gray-700">Direção perigosa: {{ $totalDireçãoPerigosa }}</span>
                </div>
                <div class="bg-gray-100 rounded-lg px-4 py-2 flex items-center justify-between">
                    <span class="font-medium text-gray-700">Congestionamento recorrente: {{ $totalCongestionamentoRecorrente }}</span>
                </div>
                <div class="bg-gray-100 rounded-lg px-4 py-2 flex items-center justify-between">
    ...
    <h1 class="text-2xl font-semibold text-gray-800">Listagem das denúncias enviadas</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">Sentimento</th>
                </tr>
            </thead>
